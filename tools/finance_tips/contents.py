...
class FinanceContents(Enum):
    ...
    SUPER_SOL = Content(
        ...
        url="https://shinhancardblog.com/1434",
        intent="금융생활지식 (금융)",
        next_action="콘텐츠 랜딩 화면 이동",
    )
